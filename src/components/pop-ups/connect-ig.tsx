...
import StepOne from "./components/connect-ig-steps/step-one";
import StepTwo from "./components/connect-ig-steps/step-two";
import StepThree from "./components/connect-ig-steps/step-three";
...
function ConnectIG({ onClose }: { onClose: () => void }) {
