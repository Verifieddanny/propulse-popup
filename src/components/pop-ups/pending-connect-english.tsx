...
import StepOne from "./components/pending-connect-steps-english/step-one";
import StepTwo from "./components/pending-connect-steps-english/step-two";
import StepThree from "./components/pending-connect-steps-english/step-three";
...
function PendingConnectEnglish({ onClose }: { onClose: () => void }) {
                        ...
                        <div className={`w-full absolute bottom-[1.2rem] left-0 flex transition-all duration-300 ease-in-out ${step === 2 ? "justify-between" : "justify-center"} items-center  transition-all duration-300 ease-in-out cursor-pointer md:px-[2.5rem] px-[1.5rem]`}>
                            {step > 1 && (
                                <div className="flex gap-x-[0.5rem] items-center cursor-pointer" onClick={() => {
                                    ...
                                    <p className="font-medium text-sm text-[#CBD5E1]">Go back</p>
                                </div>
                            )}
                            {step < 3 && (
                                <div className="flex gap-x-[0.5rem] items-center cursor-pointer" onClick={() => {
                                    ...
                                    <p className="font-medium text-sm text-[#CBD5E1]">Skip for now</p>
...
export default PendingConnectEnglish;