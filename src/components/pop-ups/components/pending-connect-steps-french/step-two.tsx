...
function StepTwo({ onHide }: { onHide: (bool: boolean) => void }) {
    ...
    return (
        <>
            <p className="font-black text-white text-[1.75rem] text-center mb-[0.46rem]">Connectons vos comptes</p>
            <p className="text-[#CBD5E1] text-center mb-[2.5rem]">Pour commencer à développer votre compte<br /> Instagram, vous devez connecter votre profil à<br /> notre système de croissance.</p>
                    ...
                    <>
                        ...
                        <div className="w-full flex justify-between transition-all duration-300 ease-in-out">
                            <div className="flex gap-x-2 items-center">
                                ...
                                <div className="flex flex-col">
                                    <p className="font-semibold text-white">@nomdutilisateur</p>
                                    <p className="text-[#CBD5E1] font-sm transition-all duration-300 ease-in-out">Demander l&apos;accès</p>
                                </div>
