...
function StepTwo({ setNext }: { setNext: (value: boolean) => void }) {
    ...
    return (
        <>
            <p className="font-black text-white text-[1.75rem] text-center mb-[0.46rem]">Two-Factor Authentication</p>
            <p className="text-[#CBD5E1] text-center mb-[2.5rem]">Your account has two-factor authentication<br /> currently enabled. In order to start growing your<br /> Instagram account, please provide us with<br /> a backup code to get your account started.</p>
            ...
            <div className="w-full rounded-[0.75rem] p-[0.625rem] bg-[#1E293B] border-[0.5px] border-[#334155] flex justify-between transition-all duration-300 ease-in-out flex-col">
                <div className="flex gap-x-2 items-center">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-[#CBD5E1] font-sm transition-all duration-300 ease-in-out">Add a 8-digit backup code</p>
                    </div>
                </div>
                {isConfirmed ? (<>
                    ...
                    <div className='flex items-center gap-x-[0.5rem] justify-center w-full'>
                        <p className='text-sm italic font-medium text-[#CBD5E1]'>How to find backup codes?</p>
                        <Next />
                    </div>
                </>)}
            </div>
