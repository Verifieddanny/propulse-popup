...
function StepThree({setFinished}: {setFinished: (value: boolean) => void}) {
    ...
    return (
        <>
            <p className="font-black text-white text-[1.75rem] text-center mb-[0.46rem]">Note competitors<br/>
& similar profiles</p>
            <p className="text-[#CBD5E1] text-center mb-[1.75rem]">Please add between 2 and 5 competitors or<br/> similar accounts to yours.</p>

            <p className='font-semibold mb-[0.75rem]'>Which Instagram accounts are similar to yours?</p>
