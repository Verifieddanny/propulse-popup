...
import StepTwo from "../components/connect-ig-steps-english/step-two";
...
function TwofactorEnglish({ onClose }: { onClose: () => void }) {
...
export default TwofactorEnglish;
